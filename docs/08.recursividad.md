...
2. **Declarativa**: Expresa "qué" hacer, no "cómo" hacerlo paso a paso
3. **Pattern matching**: Se integra perfectamente con el estilo funcional
4. **Tail Call Optimization**: Elixir optimiza la recursividad de cola automáticamente

Con la recursividad, podemos escribir código que resuelva cualquier problema que pueda ser descompuesto en subproblemas más pequeños, lo que es una característica fundamental de la programación funcional.
