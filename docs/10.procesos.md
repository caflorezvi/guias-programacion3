...
En los ejemplos anteriores, como el **proceso hijo no hace una tarea costosa**, no hay problema ya que alcaza a ejecutarse antes de que el proceso principal termine. Pero si el proceso hijo realiza una tarea que toma tiempo, es posible que no alcance a completarse antes de que el proceso principal finalice, lo que puede llevar a resultados inesperados.
