...
```
Aquí, el control del flujo y la gestión del estado son manuales y explícitos.
...
La Programación Funcional es el principal paradigma declarativo que estudiaremos. Trata la computación como la evaluación de funciones matemáticas y se fundamenta en varios principios clave para evitar la complejidad del estado mutable. Estos principios los estudaremos en detalle más adelante.
