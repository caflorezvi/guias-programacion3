...
Gracias a la función `Task.async/1`, el proceso principal puede lanzar múltiples tareas que se ejecutan en paralelo, aprovechando la concurrencia de Elixir. Luego, con `Task.await/1`, puede esperar a que cada tarea termine y recolectar sus resultados de manera ordenada.
