...
Se espera que la ejecución secuencial tome aproximadamente 15 segundos (1+2+3+4+5), mientras que la ejecución concurrente debería tomar alrededor de 5 segundos, ya que todas las tareas se ejecutan al mismo tiempo.
