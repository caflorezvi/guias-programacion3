...
> **💡 Nota:** Aunque más adelante veremos ejemplos prácticos, es recomendable consultar la documentación oficial para explorar todas las funciones disponibles en el módulo `Node`.
