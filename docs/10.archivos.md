...
- `File.write/3`: Con opciones (ej: `[:append]` para agregar en lugar de sobrescribir)
...
Para más información sobre `File`, `IO` y `Path`, consulte la documentación oficial de Elixir:
