...
Note que el valor por hora se escribe con decimales (`20000.0`). Si escribe `20000` el programa se cae, que es justamente el problema que este ejemplo va a resolver:
