...
Para más información puede leer acerca del [Módulo String](https://hexdocs.pm/elixir/String.html), [Módulo Integer](https://hexdocs.pm/elixir/Integer.html) y [Módulo Float](https://hexdocs.pm/elixir/Float.html). Adicionalmente, se recomienda visitar [este link](https://hexdocs.pm/elixir/case-cond-and-if.html#case) para profundizar en el uso de la estructura `case` y [este link](https://hexdocs.pm/elixir/pattern-matching.html) para entender el **pattern matching**.
