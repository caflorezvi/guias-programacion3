...
**Solución:** consulte la cookie de cada nodo con `Node.get_cookie()` y establezca la misma en todos, como se explicó en los requisitos previos.
...
**Solución:** inícielo con `epmd -daemon` y verifique con `epmd -names`, como se explicó en los requisitos previos.
...
**Solución:** unifique el tipo de nombre en todo el clúster, según la sección *Nombres de nodos*.
