...
Más adelante veremos ejemplos, pero conviene revisar la documentación oficial para conocer todas las funciones del módulo en este enlace: [https://elixir.hexdocs.pm/Node.html](https://elixir.hexdocs.pm/Node.html).
...
A nivel de código, el nombre del nodo se escribe así:
...
A nivel alto, la comunicación entre los dos nodos se representa así:
