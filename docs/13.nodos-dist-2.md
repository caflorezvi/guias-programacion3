...
Investigue y explique cómo `:global` maneja la sincronización de la tabla de nombres entre nodos. ¿Qué sucede si un nodo se desconecta o se conecta después de que otros nodos ya han registrado nombres globales?
