...
Para más información, consulte la [documentación de comprehensions](https://hexdocs.pm/elixir/comprehensions.html) y la [documentación de Keyword](https://hexdocs.pm/elixir/Keyword.html).
...
- `Enum.sort_by/2`: Ordena los elementos de la colección según una función.
...
- `Enum.sum/1`: Devuelve la suma de los elementos de la colección (si son numéricos).
