...
El **uso del operador pipe `|>` es muy común en Elixir** y se utiliza para encadenar funciones, tal como se introdujo en la guía anterior al hablar de composición. En futuros ejercicios, se puede aprovechar esta característica para simplificar aún más el código y hacerlo más legible.
