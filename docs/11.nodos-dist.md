...
Modifique los nombres de los nodos en los archivos `servidor.exs` y `cliente.exs` para que reflejen las direcciones IP correctas de las máquinas donde se ejecutarán. Asegúrese de que las máquinas puedan comunicarse entre sí a través de la red y que las cookies coincidan. Pruebe la aplicación en este entorno distribuido.
