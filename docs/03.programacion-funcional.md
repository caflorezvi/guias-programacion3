...
Gracias a la **inmutabilidad** vista en la sección 1, ese valor capturado nunca cambia: cada función fabricada queda ligada de forma definitiva al valor que recibió al crearse.
...
A diferencia de lenguajes como Haskell, **Elixir evalúa de forma estricta (*eager*) por defecto**: la evaluación perezosa es opcional y se habilita mediante el módulo `Stream`. Por eso, más que un principio universal de la programación funcional, en Elixir es una herramienta que se usa cuando conviene. Más adelante veremos ejemplos prácticos de este concepto.
