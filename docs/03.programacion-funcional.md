...
Programación III - Principios de la Programación Funcional en Elixir
Docente: Carlos Andrés Florez V.
```

# Principios de la Programación Funcional en Elixir
...
A continuación, exploraremos los principios fundamentales de la programación funcional, ilustrándolos con ejemplos prácticos en Elixir.

## Principio 1: Inmutabilidad

La inmutabilidad es quizás el pilar más importante de la programación funcional. Un valor inmutable es aquel que **no puede ser modificado** después de haber sido creado.

En lugar de alterar datos existentes, cualquier función que "modifica" algo, en realidad, devuelve una **copia nueva** con el cambio aplicado, dejando el dato original intacto.
...
## Principio 2: Funciones Puras y Efectos Secundarios
...
## Principio 3: Funciones como Ciudadanos de Primera Clase
...
## Principio 4: Composición de Funciones
