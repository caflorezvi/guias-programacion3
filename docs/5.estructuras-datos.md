...
Una estructura de datos es una forma de organizar y almacenar datos en una computadora para que puedan ser utilizados de manera eficiente. Para comprender las estructuras de datos en Elixir, es importante familiarizarse con su sintaxis y características principales. A continuación, se presentan algunos de los conceptos fundamentales que se abordarán en esta guía:
...
# Desempaquetar en variables (pattern matching o desestructuración)
...
- Contar cuántos autores distintos hay en el catálogo.
